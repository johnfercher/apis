...
pub async fn add_order(db_manager: OrderRepository, order: Order, ) -> Result<impl warp::Reply, warp::Rejection> {
...
pub async fn list_orders(db_manager: OrderRepository, ) -> Result<impl warp::Reply, warp::Rejection> {
    let result = db_manager.list_orders();

    respond(result, warp::http::StatusCode::OK)
}

pub async fn update(order_id: String, db_manager: OrderRepository, order: Order) -> Result<impl warp::Reply, warp::Rejection> {
...
pub async fn delete_order(order_id: String, db_manager: OrderRepository, ) -> Result<impl warp::Reply, warp::Rejection> {
...
pub async fn get_order_by_id(order_id: String, db_manager: OrderRepository, ) -> Result<impl warp::Reply, warp::Rejection> {
